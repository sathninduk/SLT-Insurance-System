...
<html>
<head>
    <title>Insura | Product Change</title>
...
<div class="container py-5">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <h2 class="text-center mb-5">Product Change</h2>
                    ...
                    <form action="">
                        ...
                        <div class="form-row mt-4" style="font-size: 16px;">
                            <div class="col-sm-5 pb-3" >
                                <label for="productChange">Product Change:</label>
                                <input type="text" class="form-control" style="height: 30px;" id="productChange"
                                       placeholder="">
                            </div>
                            <div class="col-sm-5 pb-3" >
                            ...
                            <div class="col-sm-5 pb-3" >
                                <label for="plcName">Policy Holder Name:</label>
                                <input type="text" class="form-control" style="height: 30px;" id="plcName"
                                       placeholder="">
                            </div>
                            <div class="col-sm-5 pb-3" >
                                <label for="nic">NIC:</label>
                                <input type="text" class="form-control" style="height: 30px;" id="nic"
                                       placeholder="">
                            </div>
                            <div class="col-sm-5 pb-3">
                            ...
                            <div class="col-sm-5 pb-3">
                                <label for="requestProduct">Request a Product:</label>
                                <div class="dropdown">
                                    <button class="btn btn-secondary dropdown-toggle btn btn-secondary btn-lg" style="width: 200px;" type="button" id="requestProduct" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Select a Product
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="#">Action</a>
