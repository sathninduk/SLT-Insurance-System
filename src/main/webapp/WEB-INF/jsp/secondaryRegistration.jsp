...
<html>
<head>
    <title>Insura | Secondary Registration</title>
...
<div class="container py-5">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <h2 class="text-center mb-5">Secondary Registration</h2>
                    ...
                    <form action="">
                        <div class="form-row mt-4" style="font-size: 16px;">
                            ...
                            <div class="col-sm-5 pb-3">
                                ...
                                <input type="text" class="form-control" style="height: 30px;" id="product"
                                       placeholder="">
                            </div>

                            <div class="col-sm-5 pb-3">
                                <label for="rProduct">Request Product:</label>
                                <input type="text" class="form-control" style="height: 30px;" id="rProduct" placeholder="">
                            </div>
                            <div class="col-sm-5 pb-3">
                                <label for="product">Product:</label>
                                <div class="dropdown">
                                    <button class="btn btn-secondary dropdown-toggle btn btn-secondary btn-lg"
                                            style="width: 200px;" type="button" id="product-2" data-toggle="dropdown"
                    ...
                    <form action="">
                        <div class="form-row mt-4" style="font-size: 16px;">
                            ...
                            <div class="col-sm-5 pb-3">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-secondary dropdown-toggle btn btn-secondary btn-lg"
                                            style="width: 200px;" type="button" id="title" data-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false">
                                        Select an Item
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
